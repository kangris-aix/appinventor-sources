...
public interface OdeMessages extends Messages, AutogeneratedOdeMessages {
  ...
  @DefaultMessage("<p>An interstitial ad is a full-page ad. AdAmazonInterstitial component allows you to monetize your app. You must have a valid Amazon Application Key. If your application key is invalid, the ad will not display on the emulator or the device. Warning: Make sure you are in test mode during development to avoid being disabled for clicking your own ads.</p>")
  @Description("")
  String AdAmazonInterstitialHelpStringComponentPallette();

  @DefaultMessage("<p>AdMob component allows you to monetize your app. You must have a valid AdMob account and AdUnitId that can be obtained from http://www.google.com/admob . If your id is invalid, the AdMob banner will not display on the emulator or the device.Warning: Make sure you are re in test mode during development to avoid being disabled for clicking your own ads.</p>")
  @Description("")
  String AdMobHelpStringComponentPallette();

  @DefaultMessage("<p>An interstitial ad is a full-page ad. AdMobInterstitial component allows you to monetize your app. You must have a valid AdMob account and AdUnitId that can be obtained from http://www.google.com/admob . If your id is invalid, the AdMobInterstitial will not display on the emulator or the device. Warning: Make sure you are in test mode during development to avoid being disabled for clicking your own ads.</p>")
  @Description("")
  String AdMobInterstitialHelpStringComponentPallette();
	
  @DefaultMessage("AdMob")
  @Description("")
  String adMobComponentPallette();

  @DefaultMessage("AdMobInterstitial")
  @Description("")
  String adMobInterstitialComponentPallette();
	
  @DefaultMessage("errMessage")
  @Description("")
  String errMessageParams();

  @DefaultMessage("amount")
  @Description("The amount that was set up in the AdMob")
  String amountParams();

  @DefaultMessage("Rewarded")
  @Description("User should be rewarded")
  String RewardedEvents();

  @DefaultMessage("AdOpened")
  @Description("AD was opened")
  String AdOpenedEvents();

  @DefaultMessage("Rewarded video ads are full screen video ads that users have the option of watching in full in exchange for in-app rewards.")
  @Description("")
  String RewardedVideoHelpStringComponentPallette();

  @DefaultMessage("RewardedVideo")
  @Description("")
  String rewardedVideoComponentPallette();

  @DefaultMessage("ShowAd")
  @Description("Starts to show the AD")
  String ShowAdMethods();
}
